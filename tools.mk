...
override CDEFS := $(filter-out -DSYS_GFX_SOKOL -DSYS_GFX_DRM -DSOKOL_GLCORE -DSOKOL_METAL -DSOKOL_D3D11 -DSOKOL_GLES3 -DSOKOL_DEBUG=1 -DSYS_LOG_LEVEL% -DSYS_DISPLAY_SCALE_H% -DDRM_PLANE_ROT_DEG% -DEGL_NO_X11 -DMESA_EGL_NO_X11_HEADERS -DAPP_INITIAL_SCRN% -DDEV,$(CDEFS))
