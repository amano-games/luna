...
rec_i32 fnt_draw_str_block(struct gfx_ctx ctx, struct fnt fnt, struct str8_list lines, rec_i32 layout, i32 tracking, i32 leading, i32 visible_chars, enum spr_mode mode, u32 align_flags);
