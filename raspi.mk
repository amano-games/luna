...
LDLIBS := -lm -lGLESv2 -lEGL -lgbm -ldrm -lasound -lpthread -lrt -ldl
...
override CDEFS := $(CDEFS) -DSYS_GFX_DRM -D_GNU_SOURCE -DEGL_NO_X11 -DMESA_EGL_NO_X11_HEADERS -DSYS_DISPLAY_SCALE_H=$(RASPI_DISPLAY_SCALE_H) -DDRM_PLANE_ROT_DEG=$(RASPI_PLANE_ROT_DEG)
